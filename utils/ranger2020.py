...
class Ranger(Optimizer):
    ...
    def step(self, closure=None, lr_adjust = 1.0, rebound_fac = 1.0):
        loss = None
        ...
        for group in self.param_groups:
            ...
            for p in group['params']:
                ...
                p_data_fp32.add_(G_grad, alpha=-step_size * group['lr'] * lr_adjust)
                ...
                if state['step'] % group['k'] == 0:
                    ...
                    slow_p.add_(p.data - slow_p, alpha=self.alpha * rebound_fac)
                    # copy interpolated weights to RAdam param tensor
                    p.data.copy_(slow_p)
                    # print ("slow weights updated..")
